...
func Usage() {
  fmt.Fprintf(os.Stderr,`usage: [-s start page(>=1)] [-e end page(>=s)] [-l length of page(default 72)] [-f type of file(default 1)] [-d dest] [filename specify input file]`)
}
